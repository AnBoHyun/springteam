...
public class BoardController {
	...
	/*
	 * public String writeProcedure(@Valid @ModelAttribute("writeContentDTO")
	 * ContentDTO writeContectDTO, BindingResult result) {
	 */

	public String writeProcedure(@ModelAttribute("writeContentDTO") ContentDTO writeContectDTO) {
		/*
		 * if (result.hasErrors()) {
		 * 
		 * return "board/write"; }
	...
	/*
	 * // 수정 화면 (page 파라미터 관련 주석 처리)
	 * 
	 * @GetMapping("/modify") public String modify(@RequestParam("board_info_idx")
	 * int board_info_idx,
	 * 
	 ...
	 * System.out.println("게시글번호 : " + content_idx); // // ContentDTO tmpContentDTO
	 ...
	 * 
	 * // model.addAttribute("page", page); // page 파라미터 관련 주석 처리
	 * 
	 * return "board/modify"; }
	 */

	@GetMapping("/modifyone")
	public String modifyone(@ModelAttribute("modifyContentDTO") ContentDTO modifyContentDTO) {
		System.out.println("test1");
		

		return "board/modify1";
	}

	// 수정 처리 (page 파라미터 관련 주석 처리)
